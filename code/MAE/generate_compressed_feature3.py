...
train_output_path = f'../data/full_dataset/train_data_with_mae_embeddings_{ts}.pkl'
val_output_path = f'../data/full_dataset/val_data_with_mae_embeddings_{ts}.pkl'
...
embeddings_output_path = f'../data/full_dataset/mae_embeddings_{ts}.npz'
